...
bool j1Audio::Awake(pugi::xml_node& config)
{
	...
	boat_attack = App->audio->LoadFx("assets/audio/fx/boat-attack.wav");
	boat_destroy = App->audio->LoadFx("assets/audio/fx/boat-destroy.wav");
	boat_spawn = App->audio->LoadFx("assets/audio/fx/boat-spawn.wav");
	harvester_destroy = App->audio->LoadFx("assets/audio/fx/harvester-destroy.wav");
	harvester_spawn = App->audio->LoadFx("assets/audio/fx/harvester-spawn.wav");
	harvester_work = App->audio->LoadFx("assets/audio/fx/harvester-work.wav");
	structure_build = App->audio->LoadFx("assets/audio/fx/structure-build.wav");
	structure_destroy = App->audio->LoadFx("assets/audio/fx/structure-destroy.wav");
	ui_open = App->audio->LoadFx("assets/audio/fx/ui-open.wav");
	ui_purchase = App->audio->LoadFx("assets/audio/fx/ui-purchase.wav");
	ui_wood_hit = App->audio->LoadFx("assets/audio/fx/ui-click.wav");
	logo_audio = App->audio->LoadFx("assets/audio/fx/logo-intro.wav");
	welcome_voice = App->audio->LoadFx("assets/audio/fx/welcome.wav");
	start = App->audio->LoadFx("assets/audio/fx/start-game.wav");
	you_are_not_prepared = App->audio->LoadFx("assets/audio/fx/you-are-not-prepared.wav");
	this_will_be_fun = App->audio->LoadFx("assets/audio/fx/this-will-be-fun.wav");	
	such_arrogance = LoadFx("assets/audio/fx/such-arrogance.wav");
	ha = LoadFx("assets/audio/fx/ha.wav");
	no = LoadFx("assets/audio/fx/no.wav");
	quest_start = App->audio->LoadFx("assets/audio/fx/quest-start.wav");
	quest_completed = App->audio->LoadFx("assets/audio/fx/quest-completed.wav");
	carrier_spawn = App->audio->LoadFx("assets/audio/fx/carrier-spawn.wav");
	carrier_raise = App->audio->LoadFx("assets/audio/fx/carrier-raise.wav");
	carrier_descend = App->audio->LoadFx("assets/audio/fx/carrier-descend.wav");
	...
	mainmenu_music = LoadMusic("assets/audio/music/tavern-song.wav");
	ingame_chill_music = LoadMusic("assets/audio/music/song.wav");
