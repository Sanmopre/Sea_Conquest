...
void j1InGameUI::Add_UI()
{
	...
	menu.Resume_button = App->gui->AddElement(GUItype::GUI_BUTTON, nullptr, { MiddleScreenW + 25,MiddleScreenH -60}, { 76,30 }, true, false, { 0,0,200,65 }, "SAVE", this, false, false, SCROLL_TYPE::SCROLL_NONE, true, TEXTURE::BUTON);
